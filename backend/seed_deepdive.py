...
LOCATIONS: List[Dict[str, Any]] = [
    ...
    # MIGO Mini-golf & Spill-Park — Eschweiler (Wiltz canton, Northern LU)
    {
        "title": l("MIGO — Mini-Golf & Indoor Playground",
                    "MIGO — Minigolf & Indoor-Spielplatz",
                    "MIGO — Mini-golf & Aire de jeux couverte"),
        "short": l("Northern LU indoor playground (0-12) + 14 mini-golf lanes.",
                    "Nord-Luxemburg Indoor-Spielplatz (0-12) + 14 Minigolf-Bahnen.",
                    "Aire couverte 0-12 ans + 14 pistes de mini-golf."),
        "description": l(
            "230 m² indoor playground for kids 0-12 (dedicated toddler section, slides, trampolines, tunnels) plus 14 indoor mini-golf lanes. In the village of Eschweiler, Wiltz municipality, close to Wiltz and Clervaux.",
            "230 m² Indoor-Spielplatz für 0-12 Jahre (eigener Kleinkind-Bereich, Rutschen, Trampoline, Tunnel) plus 14 Indoor-Minigolf-Bahnen. In Eschweiler (Gemeinde Wiltz), nahe Wiltz und Clervaux.",
            "Aire de jeux couverte de 230 m² pour 0-12 ans + 14 pistes de mini-golf. À Eschweiler (commune de Wiltz), près de Wiltz et Clervaux.",
        ),
        "type": "Indoor", "canton": "Wiltz", "town": "Eschweiler",
        "category": ["Playgrounds", "Sports"],
        "age_min": 0, "age_max": 12,
        "time": "10:00 - 20:00",
        "price_adult": 0.0, "price_child": 8.0,
        "price_label": l("EUR ~8 / child · adult free",
                          "ca. 8 € / Kind · Erwachsene gratis",
                          "~8 € / enfant · adulte gratuit"),
        "accessibility": l("Level access, wheelchair OK", "Ebenerdig, rollstuhlgerecht",
                            "Plain-pied, accessible PMR"),
        "weather_fit": l("Great when it rains", "Perfekt bei Regen", "Idéal sous la pluie"),
        "lat": 50.0033, "lng": 5.9636,
        "website_url": "https://www.migo.lu/en",
        "accessibility_wheelchair": True,
        "sensory_friendly": False,
        "free_parking": True,
        "sensory_notes": l("Loud and stimulating during peak hours. Bring ear protection.",
                            "Laut und reizintensiv zu Stoßzeiten. Gehörschutz mitnehmen.",
                            "Bruyant aux heures de pointe. Apportez une protection auditive."),
        "parking": l("Free parking on site.", "Gratis Parkplatz vor Ort.", "Stationnement gratuit sur place."),
        "food_allowed": False,
        "food_onsite": l("Snack bar / café on site.", "Snack-Bar/Café vor Ort.", "Snack/café sur place."),
        "preparation_tips": l("Anti-slip socks required. Wear comfortable clothes.",
                                "Stoppersocken erforderlich. Bequeme Kleidung.",
                                "Chaussettes anti-dérapantes. Tenue confortable."),
        "payment_methods": ["Cash", "Card"],
        "opening_hours": l("Daily 10:00-20:00 (check website in low season)",
                            "Täglich 10:00-20:00 (Website in Nebensaison prüfen)",
                            "Tous les jours 10h-20h (vérifier hors saison)"),
        "peak_hours": l("Rainy weekend afternoons",
                          "Regnerische Wochenend-Nachmittage",
                          "Après-midi week-end pluvieux"),
        "changing_facilities": True, "restrooms": True,
    },
]
